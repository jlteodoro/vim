...
let g:colors_name = "colorful256"
 ...
 highlight Normal       cterm=none    ctermfg=249 ctermbg=16  gui=none    guifg=#ffffff guibg=#000000
 highlight Special      cterm=none    ctermfg=105 ctermbg=16  gui=none    guifg=#8787ff guibg=#000000
 highlight Comment      cterm=none    ctermfg=3   ctermbg=16  gui=none    guifg=#0AF612 guibg=#000000
 ...
 highlight PreProc      cterm=none    ctermfg=10  ctermbg=16  gui=none    guifg=cyan guibg=#000000
 ...
 highlight Identifier   cterm=none    ctermfg=207 ctermbg=16  gui=none    guifg=#5FA5FF guibg=#000000
 highlight SpecialKey   cterm=none    ctermfg=36  ctermbg=16  gui=none    guifg=#00af87 guibg=#000000
 highlight NonText      cterm=none    ctermfg=164 ctermbg=16  gui=none    guifg=cyan guibg=#000000
 ...
 highlight Title        cterm=none    ctermfg=199 ctermbg=16  gui=none    guifg=#E695BA guibg=#000000
 highlight WarningMsg   cterm=none    ctermfg=9   ctermbg=16  gui=none    guifg=#ff0000 guibg=#000000
 highlight DiffDelete   cterm=none    ctermfg=207 ctermbg=16  gui=none    guifg=#5FA5FF guibg=#000000
 ...
 highlight StatusLine   cterm=reverse ctermfg=58  ctermbg=15  gui=reverse guifg=#80F0A6 guibg=#ffffff
 ...
 highlight User1        cterm=none    ctermbg=20  ctermfg=15  gui=none    guibg=cyan guifg=#ffffff
 highlight User2        cterm=none    ctermbg=20  ctermfg=46  gui=none    guibg=cyan guifg=#00ff00
 highlight User3        cterm=none    ctermbg=20  ctermfg=46  gui=none    guibg=cyan guifg=#00ff00
 highlight User4        cterm=none    ctermbg=20  ctermfg=50  gui=none    guibg=cyan guifg=#00ffdf
 highlight User5        cterm=none    ctermbg=20  ctermfg=46  gui=none    guibg=cyan guifg=#00ff00
...
if exists('loaded_taglist')
   ...
   highlight TagListTitle    cterm=none ctermfg=199 ctermbg=16 gui=none guifg=#E695BA guibg=#000000
